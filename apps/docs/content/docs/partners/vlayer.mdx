...
1. **Clone the example**:
   ```bash
   git clone https://github.com/mcpay-tech/mcpay.fun.git
...
- [VLayer Documentation](https://vlayer.io) - Learn more about zkTLS and web proofs
- [Example Repository](https://github.com/mcpay-tech/mcpay.fun/tree/main/examples/vlayer-client-example) - Full working example
- [MCPay GitHub](https://github.com/mcpay-tech/mcpay.fun) - Source code and more examples
